    ...
    <section id="work" className="relative mx-auto max-w-6xl px-6 py-28 sm:py-36">
      ...
      <div className="mt-16 grid gap-5 sm:grid-cols-2">
        {PROJECTS.map((p, i) => (
          ...
          >
            <article className="spotlight-edge group relative cursor-pointer overflow-hidden rounded-2xl border border-white/8 bg-white/[0.02] transition-all duration-500 hover:-top-1.5 hover:border-edge/30 hover:shadow-[0_30px_80px_-30px_oklch(0.82_0.12_220/0.3)]">
